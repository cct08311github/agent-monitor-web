// ---------------------------------------------------------------------------
// cronPins.ts — per-cron-job pin state, persisted to localStorage.
// Mirrors the capturePins design: loadPins / savePins / togglePin /
// isPinned / partition.  Pinned jobs float to the top of the CronTab list.
// ---------------------------------------------------------------------------

const KEY = 'oc_cron_pinned'
